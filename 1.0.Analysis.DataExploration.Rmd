...
```
They are not. This is because some movies has the same title but not the same movieId...Why? Because they are released in different year!
...
movielens %>%
  ...
  geom_histogram(bins = 30, color = "black") + 
  ggtitle("Rating by Year of the movie") +
  xlab("Rating")
```
